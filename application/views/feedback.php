                ...
                <div class="-mx-4 flex flex-wrap lg:justify-between">
                    <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                        <div class="mb-12 max-w-[570px] lg:mb-0">
                            ...
                            <p class="text-body-color mb-9 text-base leading-relaxed"  data-aos="fade-right" data-aos-offset="200" data-aos-duration="1000">
                            ...
                            <div class="mb-8 flex w-full max-w-[370px]" data-aos="fade-right" data-aos-duration="1000">
                                ...
                                <div class="w-full">
                                    ...
                                    <p class="text-body-color text-base">
                                        99 S.t Banda Neira 28292. Indonesia
                                    </p>
                                </div>
                            </div>
                            <div class="mb-8 flex w-full max-w-[370px]" data-aos="fade-right" data-aos-duration="1000">
                                ...
                                <div class="w-full">
                                    ...
                                    <p class="text-body-color text-base">(+62)81 154 842 22</p>
                                </div>
                            </div>
                            <div class="mb-8 flex w-full max-w-[370px]" data-aos="fade-right" data-aos-duration="1000">
                                <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                                ...
                                <div class="w-full">
                                    ...
                                    <p class="text-body-color text-base">customercare@5percentcoffee.id</p>
                                </div>
                            </div>
                        </div>
                    </div>
